...
{
    public static GameState CreateGameBasic(
        int? centerCard1,
        int? centerCard2 = null,
        int? player1Card = null,
        int? player2Card = null,
        int? player1Kitty = null,
        int? player2Kitty = null,
        int? player1TopUp = null,
        int? player2TopUp = null,
        bool player1RequestingTopUp = false,
        bool player2RequestingTopUp = false
    ) =>
        CreateGameCustom(
            new List<int?> { centerCard1 },
            new List<int?> { centerCard2 },
            new List<int?> { player1Card },
            new List<int?> { player1Kitty },
            new List<int?> { player1TopUp },
            player1RequestingTopUp,
            new List<int?> { player2Card },
            new List<int?> { player2Kitty },
            new List<int?> { player2TopUp },
    ...
    public static GameState CreateGameCustom(
        ...
        new()
        {
            ...
            {
                new() { Cards = CreateBasicCards(centerPile1) },
