...
public static class BotNameCreator
{
    ...
    {
        var adjectivesJsonPath = Path.Combine(
        ...
        var firstNamesJsonPath = Path.Combine(
            Environment.CurrentDirectory,
            "Assets",
            "FirstNames.json"
        );
        ...
        var possibleFirstNames = firstNames
            .Where(name => name.Substring(0, 2) == adjective.Substring(0, 2))
            .ToList();
